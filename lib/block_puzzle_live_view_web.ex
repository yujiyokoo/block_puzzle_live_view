defmodule BlockPuzzleLiveViewWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: BlockPuzzleLiveViewWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/block_puzzle_live_view_web/templates",
        namespace: BlockPuzzleLiveViewWeb
